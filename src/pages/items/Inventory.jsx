...
export default function Inventory() {
  ...
  const bgStyle={
    background:"url('https://cdn.dribbble.com/users/2698098/screenshots/5957957/untitled-2-01_4x.jpg')",
          ...
          <Grid item xs={12} lg={12}>
            ...
            <div style={{ marginTop: "-55px" }} align="center"> 
              {items.length<=0?<div style={{
                ...
                <div>
                <img src="https://cdn.dribbble.com/users/2698098/screenshots/5957957/untitled-2-01_4x.jpg" height="400px"/>
               
                </div>
                <br />

                <div>
                  <Typography variant="h5" align="center" color="slategray">No data added yet</Typography>
                </div>
              </div>:
